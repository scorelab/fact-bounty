...
class CtodaySpider(scrapy.Spider):
    ...
    start_urls = [
        "http://www.ceylontoday.lk/news/8",
        "http://www.ceylontoday.lk/news/5",
        "http://www.ceylontoday.lk/news/14",
        "http://www.ceylontoday.lk/news/7",
        "http://www.ceylontoday.lk/news/4",
        "http://www.ceylontoday.lk/news/6",
        "http://www.ceylontoday.lk/news/2",
        "http://www.ceylontoday.lk/news/15",
    ]
    ...
    def parse_article(self, response):
        ...
        item["content"] = (
            news["HTML_Content"].replace("<p>", "").replace("</p>", "\n")
        )
