                ...
                <div className="container">
                    <form>
                        <div className="search-form">
                            ...
                            <TextField variant="outlined" margin="normal" style={{ width: "80%" }} label="Enter any phrase" value={this.state.queryText} onChange={this.handleChange} id="queryText" />
                        </div>
                        <div className="check-box-list">
                            <div className="radio-container">
                                <label className="show-label">Show:</label>
                                <input type="radio" name="sort_by" id='queryType' value="relevant" onChange={this.handleChange} /> Relevant
                            </div>
                            <span className="radio-container">
                                <label className="">
                                    <input type="radio" name="sort_by" id="queryType" value="recent" onChange={this.handleChange} /> Recent
							</label>
                            </span>
                            <span className="radio-container">
                                <label className="">
                                    <input type="radio" name="sort_by" id="queryType" value="mixed" onChange={this.handleChange} /> Mixed
							</label>
                            </span>
                        </div>
                        <div className="col-12 text-center">
                            <input type="hidden" name="include_user_mentions" id="include_user_mentions_true" value="true" />
                            <Button className="btn btn-primary btn-blue" id="submit" variant="contained" color="primary" style={{ width: "50%" }} onClick={this.submitForm}>Search</Button>
                        </div>
                    </form>
                </div>
