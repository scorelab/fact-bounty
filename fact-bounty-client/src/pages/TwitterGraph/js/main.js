...
var Main = function (query, result_type) {
    ...
    var globalTwitterSearchTimeline = new TwitterSearchTimeline({ updateDateRangeCallback: updateGraph, graphAnimation: graphAnimation });
    globalTwitterSearchTimeline.chart.interactiveLayer.dispatch.on("elementClick", function (e) {
        pauseGraphAnimation();
    ...
    function paginateTwitterRequests() {
        ...
        const tweetsResponse = twitter.getTweets(query_string, "en", "", result_type);
        tweetsResponse.then(function (response) {
            ...
            if (twitterUserSet.size < 1000 && query_string != "" && query_limit > 0) {
                // Continue pagination
